...
export function checkEmail(email) {
	const url = m1api + '/user/checkemail'
	const param = {email}
 ...
 */
export function getInviteDetail(invite_id) {
	const url = m1api + '/invite/detail'
	const param = {invite_id}
	return http.get(url, param)
}
/**
 * 同意邀请
 ...
 * @param  {String} password  
 */
export function agreeInvite(invite_id, password) {
	const url = m1api + '/invite/confirm'
	const param = {invite_id, password}
	return http.post(url, param)
}