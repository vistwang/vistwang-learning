...
import { Input, Button, Tag, Alert, Text, Icon, Modal, Colors, Sizes } from '../../../components/m1-ui'
...
class Scheme extends Component {
	...
	init() {
		if(user.cookieInfo) {
			avatar = user.cookieInfo.userinfo.accounts[0].avatar
			name 	 = user.cookieInfo.userinfo.accounts[0].fullName
		}
	}
					...
					<div className="m1-row scheme-content">
						...
						<ul>
							<li>
								...
								<p className="scheme-code"><label>推荐码：</label><Input value={recommendCode} /><Button color={Colors.PRIMARY} >复制</Button></p>
							</li>
							<li>
								...
								<p className="scheme-link"><Input value={recommendUrl} /><Button color={Colors.PRIMARY} >复制</Button></p>
							</li>
