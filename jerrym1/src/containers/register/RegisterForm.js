...
class RegisterForm extends Component {
	...
	init() {
		...
		if(this.sem === 'sem') {
			cookie.set(config.COOKIE_BAIDU_SEM, this.sem , {expires: 365, path: '/', domain: 'm1world.com'})
		}
		...
		if(this.authenticate()) {
			...
			register(param).then(result => {
				...
				if(result.success) {
					...
					cookie.remove(config.COOKIE_BAIDU_SEM, {path: '/', domain: 'm1world.com'})
					this.setFirstInfo()
	...
	setFirstInfo() {
		...
		cookie.set(config.COOKIE_M1_FIRST_LOGIN, 'true', cookieOption)

		let c = utils.getUrlParam('c')
		if(c && c.match('http')) {
			c = decodeURIComponent(c)
			cookie.set(config.COOKIE_M1_FIRST_LOGIN_URL, encodeURIComponent(c), cookieOption)
		}
	}
		...
		return (	
			<div className="sign-form">
				...
				{/*用户名*/}
					...
					{/*手机号*/}
						{isBaiduSem && <div className="m1-form-row">
													<div className="m1-form-content">
														<Icon name="phone" />
														<input 
						...
						{isBaiduSem && showVerifyCode && <div className="m1-form-row">
													<div className="m1-form-content">
						...
						{isBaiduSem && showVerifyCode && <div className="m1-form-row verify-code">
													<div className="m1-form-content">
